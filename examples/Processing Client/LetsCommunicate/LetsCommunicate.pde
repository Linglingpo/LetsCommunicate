...
void debugPrint() {
  System.out.println("");
  dubugCount ++;
  System.out.println("DubugCount: " + dubugCount);
  ...
  /* DEBUG! WHAT PROCESSING RECEIVED  - Preable*/
  System.out.print("IN array(Processing received): ");
  for (int i = 0; i < in[selected].length; i++) {
    System.out.print( in[selected][i] );
    System.out.print(" ");
  }
  System.out.println(" ");

  /* DEBUG! WHAT PROCESSING RECEIVED - Payload */
  System.out.print("PAYLOAD array(Processing received): ");
  if ( payload[ selected ] != null) {
    for (int i = 0; i < payload[selected].length; i++) {
      System.out.print( payload[selected][i] );
      System.out.print(" ");
    }
    System.out.println(" ");
  }
  ...
  /* DEBUG! WHAT PROCESSING SENT - in out array*/
  System.out.print("OUT array(Processing sent): ");
